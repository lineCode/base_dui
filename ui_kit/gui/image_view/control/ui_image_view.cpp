...
namespace nim_comp
{
	...
	//void UiImageView::HandleMessage(dui::EventArgs& event)
	//{
	//	return Control::HandleMessage(event);
	//}
#if 1
	bool UiImageView::Paint(HDC hDC, const RECT& rcPaint, Control* pStopControl /*= NULL*/)
	{
...
#else
	void UiImageView::Paint(dui::IRenderContext* pRender, const dui::UiRect& rcPaint)
	{
