...
#include "control/ui_image_view.h"
...
namespace nim_comp
{
	...
	void ImageViewForm::OnFinalMessage(HWND hWnd)
	{
		__super::OnFinalMessage(hWnd);
		delete this;
	}

	Control* ImageViewForm::CreateControl(LPCTSTR pstrClass)
	{
		if (_tcscmp(pstrClass,  _T("ImageView")) == 0)
		{
