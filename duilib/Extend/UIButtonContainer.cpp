...
namespace dui{
	...
	UINT ButtonContainer::GetControlFlags() const
	{
	...
	void ButtonContainer::SetEnabled(bool bEnable)
	{
	...
	void ButtonContainer::SetHotBkColor(DWORD dwColor)
	{
		m_dwHotBkColor = dwColor;
	}

	DWORD ButtonContainer::GetHotBkColor() const
	{
		return m_dwHotBkColor;
	}

	void ButtonContainer::SetHotTextColor(DWORD dwColor)
	{
		m_dwHotTextColor = dwColor;
	}

	DWORD ButtonContainer::GetHotTextColor() const
	{
		return m_dwHotTextColor;
	}

	void ButtonContainer::SetPushedTextColor(DWORD dwColor)
	{
		m_dwPushedTextColor = dwColor;
	}

	DWORD ButtonContainer::GetPushedTextColor() const
	{
		return m_dwPushedTextColor;
	}

	void ButtonContainer::SetFocusedTextColor(DWORD dwColor)
	{
		m_dwFocusedTextColor = dwColor;
	}

	DWORD ButtonContainer::GetFocusedTextColor() const
	{
		return m_dwFocusedTextColor;
	}

	LPCTSTR ButtonContainer::GetNormalImage()
	{
		return m_diNormal.sDrawString.c_str();
	}

	void ButtonContainer::SetNormalImage(LPCTSTR pStrImage)
	{
	...
	LPCTSTR ButtonContainer::GetHotImage()
	{
		return m_diHot.sDrawString.c_str();
	}

	void ButtonContainer::SetHotImage(LPCTSTR pStrImage)
	{
	...
	LPCTSTR ButtonContainer::GetPushedImage()
	{
		return m_diPushed.sDrawString.c_str();
	}

	void ButtonContainer::SetPushedImage(LPCTSTR pStrImage)
	{
	...
	LPCTSTR ButtonContainer::GetFocusedImage()
	{
		return m_diFocused.sDrawString.c_str();
	}

	void ButtonContainer::SetFocusedImage(LPCTSTR pStrImage)
	{
	...
	LPCTSTR ButtonContainer::GetDisabledImage()
	{
		return m_diDisabled.sDrawString.c_str();
	}

	void ButtonContainer::SetDisabledImage(LPCTSTR pStrImage)
	{
	...
	LPCTSTR ButtonContainer::GetHotForeImage()
	{
		return m_diHotFore.sDrawString.c_str();
	}

	void ButtonContainer::SetHotForeImage(LPCTSTR pStrImage)
	{
	...
	void ButtonContainer::SetFiveStatusImage(LPCTSTR pStrImage)
	{
		m_diNormal.Clear();
		m_diNormal.sDrawString = pStrImage;
	...
	void ButtonContainer::SetFadeAlphaDelta(BYTE uDelta)
	{
		m_uFadeAlphaDelta = uDelta;
	}

	BYTE ButtonContainer::GetFadeAlphaDelta()
	{
	...
	void ButtonContainer::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
	{
	...
	void ButtonContainer::PaintText(HDC hDC)
	{
	...
	void ButtonContainer::PaintStatusImage(HDC hDC)
	{
		if (IsFocused()) m_uButtonState |= UISTATE_FOCUSED;
		else m_uButtonState &= ~UISTATE_FOCUSED;
		if (!IsEnabled()) m_uButtonState |= UISTATE_DISABLED;
