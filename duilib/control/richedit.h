...
class DUILIB_API RichEdit : public ScrollBox, public IMessageFilter
{
public:
    RichEdit();
    ~RichEdit();
	...
	DuiPoint GetCharPos(long lChar) const;
    long LineFromChar(long nIndex) const;
    DuiPoint PosFromChar(UINT nChar) const;
    int CharFromPos(DuiPoint pt) const;
